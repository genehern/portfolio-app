...
const Card = ({ project }) => {
  return (
    <div className="w-full relative shadow-xl bg-white max-w-5xl mx-auto flex flex-col p-4 md:my-0 items-center mt-8 rounded-lg lg:hover:scale-105 duration-300 lg:grid grid-cols-2 lg:gap-8 lg:py-24">
      <a
        href={project.link}
        className="absolute top-0 right-0 rounded-full w-10"
        target="_blank"
      >
        {" "}
        <img
...
const Projects = () => {
  return (
    <div className="w-full py-8 px-4 flex flex-col items-center pt-24">
      <p className="text-4xl font-bold inline border-b-4  border-pink-600">
        My Projects
      </p>
      <div className="max-w-[1240px] mx-auto grid gap-8 mt-8 mb-4">
